...
def own_grid_search(model_name, train_data, test_data, train_data2): 
	...
	for idx, param_comb in enumerate(param_combs): 
		...
		for months_forward in xrange(0, 33, 1): 
			# training_set, validation_set = tt_split_same_months(train, 2013, [months_forward, months_forward + 1], days_back=None)
	...
	roc_save_filename = './model_output/roc_auc_halfmonthsprior_30_' + model_name
...
if __name__ == '__main__': 
	...
	filename = './model_output/' + model_name + '_preds_probs_halfmonthsprior_30.csv'
